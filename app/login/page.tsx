    ...
    <main className="grid min-h-dvh lg:grid-cols-2">
      ...
      <section className="relative hidden overflow-hidden bg-ink-900 lg:block">
        ...
        <div className="relative flex h-full flex-col justify-end p-14 text-white">
          ...
          <h2 className="mt-3 max-w-md text-3xl font-semibold leading-tight tracking-tight">Your technical growth and placement readiness, in one place.</h2>
          <ul className="mt-8 grid max-w-md grid-cols-2 gap-3 text-sm text-zinc-300">
            {['GitHub activity', 'LeetCode & CodeChef', 'Projects & certifications', 'Readiness score'].map(t => (
